...
const Faq = () => {
    ...
    return (
        <div className='pt-[124px] max-xl:pt-24 max-lg:pt-16 max-sm:pt-12'>
            <div className='container'>
                <div className="flex max-lg:flex-wrap justify-between">
                    {/* Sticky Image Section */}
                    <div className="lg:w-5/12 w-full max-lg:pb-7 max-lg:mx-auto sticky top-4 h-fit">
                        <img
                            className='max-w-[500px] max-xl:max-w-[448px] mx-auto'
                            src="./assets/webp/faq-girl.png"
                            alt="girl"
                        />
                    </div>
                    ...
                    <div className="lg:w-6/12 w-full">
                        <CustomHeading text="Key Q&A" className="max-lg:pb-5"></CustomHeading>
                        ...
                        {ACCORDION_DATA.map((item, index) => (
                            <div key={index} className="border-b border-lightgray">
                                ...
                                >
                                    ...
                                    <svg className={`transform transition-transform duration-500 w-[24px] h-[24px] ${activeIndex === index ? 'rotate-0' : 'rotate-180'
                        ...
                        <CustomButton text="Get a demo"></CustomButton>
                    </div>
                </div>
            </div>
        </div>
