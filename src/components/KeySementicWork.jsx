...
const KeySementicWork = () => {
  return (
      <div className='pt-24 max-sm:pt-12 max-lg:pb-12 max-lg:pt-16'>
          <div className="container">
              <CustomHeading text="How does KeySemantics work?" className="text-center pb-[56px] max-lg:pb-8"></CustomHeading>
