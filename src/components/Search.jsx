...
const Search = () => {
    return (
        <div className='py-[148px] max-xl:py-28  max-sm:py-12 max-md:py-16 max-lg:py-20'>
            <div className="container">
                <div className="flex max-lg:flex-wrap max-xl:justify-between">
                    ...
                    <div className='lg:w-5/12 w-full'>
                        <img className='max-w-[570px] max-xl:max-w-[420px] xl:ml-10 max-sm:max-w-[330px] max-lg:mx-auto max-lg:pt-6' src="./assets/webp/search.png" alt="search" />
                    </div>
                </div>
            </div>
        </div>
