            ...
            <div className="container">
                <div className="flex max-lg:flex-wrap max-xl:justify-between">
                    ...
                    <div className='lg:w-5/12 w-full'>
                        <img className='max-w-[570px] max-xl:max-w-[420px] max-lg:max-w-[450px] xl:ml-10 max-sm:max-w-[330px] max-lg:mx-auto max-lg:pt-6 pointer-events-none' src="./assets/webp/search.webp" alt="search" />
                    </div>
                </div>
            </div>
        </div>
